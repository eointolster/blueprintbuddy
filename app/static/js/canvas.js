class BlueprintCanvas {
    ...
    constructor() {
        ...
        saveToJson() {
            ...
            link.href = url;
            link.download = `blueprint_${new Date().toISOString().slice(0,10)}.json`;
            ...
            return new Promise((resolve, reject) => {
                ...
                reader.onload = (event) => {
                    try {
                        ...
                        // Find highest component ID to update nextId
                        let maxId = 0;
        ...
        showContextMenu(event, x, y) {
            ...
            if (target) {
                ...
                menuItems.push(
                    { label: 'Rename', action: () => this.startRenaming(componentId) }, // Add this line
        ...
        addPort(componentId, portType) {
            ...
            // Calculate new height based on number of ports
            const maxPorts = Math.max(component.inputs.length, component.outputs.length);
            const minHeight = 100; // Minimum height
            const portSpacing = 30; // Space between ports
        ...
        editComponentName(g, component) {
            ...
            const finishEditing = () => {
                ...
                component.name = newName || originalName;
                titleText.text(component.name).style('display', null);
...
setupZoomControls() {
    ...
    renderComponent(component) {
        ...
        const portPadding = 20; // Padding at top and bottom of ports section
        ...
        // Update component height to accommodate all ports
        ...
        // Update component width if necessary (minimum 150px or text width + padding)
